...
static const _Speech_Request_type_support_symbol_names_t _Speech_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carbot_patrol_interfaces, srv, Speech_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carbot_patrol_interfaces, srv, Speech_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carbot_patrol_interfaces, srv, Speech_Request)() {
  return &::carbot_patrol_interfaces::srv::rosidl_typesupport_c::Speech_Request_message_type_support_handle;
}
...
static const _Speech_Response_type_support_symbol_names_t _Speech_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carbot_patrol_interfaces, srv, Speech_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carbot_patrol_interfaces, srv, Speech_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carbot_patrol_interfaces, srv, Speech_Response)() {
  return &::carbot_patrol_interfaces::srv::rosidl_typesupport_c::Speech_Response_message_type_support_handle;
}
...
static const _Speech_Event_type_support_symbol_names_t _Speech_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carbot_patrol_interfaces, srv, Speech_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carbot_patrol_interfaces, srv, Speech_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carbot_patrol_interfaces, srv, Speech_Event)() {
  return &::carbot_patrol_interfaces::srv::rosidl_typesupport_c::Speech_Event_message_type_support_handle;
}
...
static const _Speech_type_support_symbol_names_t _Speech_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carbot_patrol_interfaces, srv, Speech)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carbot_patrol_interfaces, srv, Speech)),
  }
};
...
static const rosidl_service_type_support_t Speech_service_type_support_handle = {
  ...
  &Speech_Request_message_type_support_handle,
  &Speech_Response_message_type_support_handle,
  &Speech_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, carbot_patrol_interfaces, srv, Speech)() {
  return &::carbot_patrol_interfaces::srv::rosidl_typesupport_c::Speech_service_type_support_handle;
}
